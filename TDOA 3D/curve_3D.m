...
switch t                                        %switch Switch among several cases
    ...
    case 2                                      %second case generates sinusoidal curve
        ...
        [m,n]=size(a);
        c=8*rand(1,n);
        scatter3(a,b,c)                           %plot of sine curve
    ...
    case 3
        ...
        [m,n]=size(a);
        c=8*rand(1,n);
        scatter3(a,b,c)                           %plot of a randon curve
        title('Random curve')
        xlabel('X');
        ylabel('Y');
        zlabel('Z');
    ...
    case 4
        ...
        [m,n]=size(a);
        c=8*rand(1,n);
        scatter3(a,b,c)                           %plot of space filling curve
        title('Space filling curve with random values of Z')
        xlabel('X');
        ylabel('Y');
        zlabel('Z');
